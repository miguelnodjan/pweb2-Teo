...
from personas.views import personaTestView, personaCreateView, personasDeleteView, searchForHelp, personasAnotherCreateView, personasShowObject, personasListView
